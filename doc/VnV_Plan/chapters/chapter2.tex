...
Test Group 1 covers the requirements detailed in Table \ref{tab:req_test_grp_1}.
...
Test Group 2 covers the requirements detailed in Table \ref{tab:req_test_grp_2}.
